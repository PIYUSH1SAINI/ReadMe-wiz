...
async function buildPrompt(
  ...
  if (modifyExisting && existingReadmeContent) {
    // Prompt for modifying existing README
    return `
...
- **Badge Link**: Use the Git remote URL provided in Project Context (remote) for the badge hyperlink, ensuring it points to the project’s actual repository (e.g., https://github.com/<user>/<repo>). Include the ReadMe Wiz badge only in the Tech Stack section, not elsewhere in the README.
